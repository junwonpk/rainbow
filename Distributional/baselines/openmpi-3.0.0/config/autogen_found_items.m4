...
dnl
dnl Generated by ec2-user at Tue Sep 12 21:31:36 2017
...
m4_define([mca_opal_common_m4_config_component_list], [cuda, libfabric, sm, verbs, verbs_usnic])
...
m4_define([mca_opal_reachable_no_config_component_list], [])
...
m4_define([mca_orte_framework_list], [common, dfs, errmgr, ess, filem, grpcomm, iof, notifier, odls, oob, plm, ras, rmaps, rml, routed, rtc, schizo, snapc, sstore, state])
...
m4_define([mca_ompi_common_m4_config_component_list], [ompio])
...
m4_define([mca_ompi_pml_m4_config_component_list], [crcpw, ob1, ucx, v, yalla])
m4_define([mca_ompi_pml_no_config_component_list], [cm, monitoring])
