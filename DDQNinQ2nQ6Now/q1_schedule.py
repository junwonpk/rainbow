...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        print('t: ', t, 'self.nsteps: ', self.nsteps)
        self.epsilon = self.eps_begin - (self.eps_begin - self.eps_end)*(float(min(t, self.nsteps))/float(self.nsteps))
        ##############################################################
        ######################## END YOUR CODE ############## ########
