...
parser.add_argument('--T-max', type=int, default=int(200e6), metavar='STEPS', help='Number of training steps (4x number of frames)')
...
parser.add_argument('--target-update', type=int, default=int(10000), metavar='τ', help='Number of steps after which to update target network')
...
parser.add_argument('--evaluation-interval', type=int, default=250000, metavar='STEPS', help='Number of training steps between evaluations')
  ...
  while T < args.T_max:
    ...
    if T >= args.learn_start:
      ...
      if T % args.evaluation_interval == 0:
        ...
        with open('rainbow.csv', 'a') as csvfile:
            csvwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
            csvwriter.writerow([T, avg_reward, avg_Q])
